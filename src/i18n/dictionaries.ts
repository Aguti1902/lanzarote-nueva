...
const es: Dictionary = {
  ...
  home: {
    ...
    transfersKicker: "Aterriza y empieza tus vacaciones",
  ...
  tourDetail: {
    ...
    places: "Lugares que puedes visitar",
    included: "Incluido",
    notIncluded: "No incluido",
...
const en: Dictionary = {
  ...
  home: {
    ...
    transfersKicker: "Land and start your holiday",
...
const de: Dictionary = {
  ...
  home: {
    ...
    transfersKicker: "Lande und starte deinen Urlaub",
  ...
  tourDetail: {
    ...
    view: "{name} ansehen",
    highlights: "Highlights",
    places: "Orte, die Sie besuchen können",
    included: "Inbegriffen",
    notIncluded: "Nicht inbegriffen",
